...
For detailed instructions, please refer to the [CodexPad Metadata Access Feature](../../../codex_pad_guide/blob/main/docs/en/metadata.md#codexpad-metadata-access-function) documentation.
